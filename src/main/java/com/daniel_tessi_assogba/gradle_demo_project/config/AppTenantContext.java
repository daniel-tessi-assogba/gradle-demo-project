...
public class AppTenantContext implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (privateTenant != null) {
            System.out.println("Tenant Header Received: " + privateTenant);
            AppTenantContext.setCurrentTenant(privateTenant);
        } else {
            System.out.println("No Tenant Header found. Using default.");
            AppTenantContext.setCurrentTenant(DEFAULT_TENANT);
        }
